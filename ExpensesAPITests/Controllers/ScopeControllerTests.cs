...
namespace ExpensesAPITests.Controllers
{
    ...
    class ScopeControllerTests
    {
        ...
        public void Setup()
        {
            ...
            IDuserRepository = new Mock<IUserRepository<IdentityServerUser>>();
        ...
        {
            var user = new User { UserName = "Zenek", SelectedScope = new Scope { Id = 25, Name = "Test", Owner = null } };
            ...
            var controller = new ScopeController(scopeRepository.Object, unitOfWork.Object, httpContextAccessor.Object, userRepository.Object, IDuserRepository.Object, tokenRepository.Object, mapper);
        ...
        public async Task GetScopeReturnOK()
        {
            ...
            userRepository.Setup(r => r.GetUserAsync("Zenek")).Returns(Task.Run(() => new User { Id = "1234", UserName = "Zenek", SelectedScope = new Scope { Id = 25, Name = "Test", Owner = null } }));
            var controller = new ScopeController(scopeRepository.Object, unitOfWork.Object, httpContextAccessor.Object, userRepository.Object, IDuserRepository.Object, tokenRepository.Object, mapper);
        ...
        {
            var user = new User { Id = "4356", UserName = "Zenek", SelectedScope = new Scope { Id = 25, Name = "Test", Owner = null } };
            userRepository.Setup(r => r.GetUserAsync(It.IsAny<string>())).Returns(Task.Run(() => user));
            scopeRepository.Setup(r => r.GetScope(15)).Returns(Task.Run(() => new Scope { Id = 15, Name = "Scope1", OwnerId = "4356" }));
            scopeRepository.Setup(r => r.GetScopes()).Returns(Task.Run(() => new List<Scope> { new Scope { Id = 15, Name = "Scope1", OwnerId = "4356" } }));
        ...
        {
            var user = new User { Id = "43656", UserName = "Zenek", SelectedScope = new Scope { Id = 25, Name = "Test", Owner = null } };
            userRepository.Setup(r => r.GetUserAsync(It.IsAny<string>())).Returns(Task.Run(() => user));
            scopeRepository.Setup(r => r.GetScope(15)).Returns(Task.Run(() => new Scope { Id = 15, Name = "Scope1", OwnerId = "4356" }));
            scopeRepository.Setup(r => r.GetScopes()).Returns(Task.Run(() => new List<Scope> { new Scope { Id = 15, Name = "Scope1", OwnerId = "4356" } }));
        ...
        {
            var user = new User { Id = "43656", UserName = "Zenek", SelectedScope = null };
            userRepository.Setup(r => r.GetUserAsync(It.IsAny<string>())).Returns(Task.Run(() => user));
            scopeRepository.Setup(r => r.GetScope(15)).Returns(Task.Run(() => new Scope { Id = 15, Name = "Scope1", OwnerId = "4356" }));
            scopeRepository.Setup(r => r.GetScopes()).Returns(Task.Run(() => new List<Scope> { new Scope { Id = 15, Name = "Scope1", OwnerId = "4356" } }));
        ...
        {
            var user1 = new User { Id = "43656", UserName = "Zenek", SelectedScope = null };
            var user2 = new User { Id = "4356", UserName = "Wojtek", SelectedScope = null }; 
            httpContext.Setup(c => c.User)
                    .Returns(new ClaimsPrincipal(new List<ClaimsIdentity>
                            {
        ...
        public async Task AddUserToScopeReturnsOK()
        {
            ...
            var result = await controller.AddUserToScope(15, "4356", "abc@example.com");
        ...
        public async Task AddUserToScopeReturnsNotFoundForNoUser()
        {
            ...
            var result = await controller.AddUserToScope(15, "0", "abc@example.com");
        ...
        public async Task AddUserToScopeReturnsBadRequestOnNotExistentUser()
        {
            ...
            var result = await controller.AddUserToScope(15, "1234", "abc@example.com");
            var badRequestResult = result as BadRequestObjectResult;
