...
namespace ExpensesAPI.SimpleJWTAuth
{
    public static class JwtAuthExtensions
    {
        ...
        public static IServiceCollection AddSimpleJWTAuth<TUser, TContext>(this IServiceCollection services, IConfiguration configuration) where TUser: class where TContext: DbContext
        {
            // jwt wire up
